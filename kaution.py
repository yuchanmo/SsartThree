...
if __name__=='__main__':
    auctiontypes = {'weekly':list(range(274,278)),'major':list(range(1,143)),'premium':list(range(1,129))}
    for ak,auc_num in auctiontypes.items():
        downloadImages(ak,auc_num,json_base_path='/mnt/auc/datas/que/k',image_base_path='/mnt/auc/images/k',useMultiProcessing=True)